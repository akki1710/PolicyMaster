...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="NV">NV</button>
    <button id="btn1" type="submit" name="bk1" value="FREEDOM">FREEDOM</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="NV 4S">NV 4S</button>
    <button id="btn1" type="submit" name="bk1" value="STAR">STAR</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SELECT II">SELECT II</button>
    <button id="btn1" type="submit" name="bk1" value="CRD 100">CRD 100</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ENERGY">ENERGY</button>
	<button id="btn1" type="submit" name="bk1" value="GRAPTOR">GRAPTOR</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ADRENO">ADRENO</button>
    <button id="btn1" type="submit" name="bk1" value="BEAMER">BEAMER</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SENSATION">SENSATION</button>
