...
<h3>Your details</h3>
 <li>	
		...
		<div class="w3ls-name">	
			<input type="text" name="travellers" placeholder="Select Family Members" value="<%= (String) session.getAttribute("travellers")%>" class="btn btn-link-1 launch-modal" data-modal-id="modal-login" required=" "/>
		</div>
		</li>
 <li>
	...
	<li>
			...
			<span class="agile_sub-label">
			<input type="button1" id="datepicker" class="button1" name="startdate">
			</span>
			<span class="agile_sub-label xxx">
