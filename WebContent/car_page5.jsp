...
<p>CAR INSURANCE</p>
    ...
    <button id="btn3" type="submit" name="Regyr" value="Brandnew">I have a Brand New Car</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="2017">2017</button>
    <button id="btn2" type="submit" name="Regyr" value="2016">2016</button>
    <button id="btn2" type="submit" name="Regyr" value="2015">2015</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="2014">2014</button>
    <button id="btn2" type="submit" name="Regyr" value="2013">2013</button>
    <button id="btn2" type="submit" name="Regyr" value="2012">2012</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="2011">2011</button>
	<button id="btn2" type="submit" name="Regyr" value="2010">2010</button>
    <button id="btn2" type="submit" name="Regyr" value="2009">2009</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="2008">2008</button>
    <button id="btn2" type="submit" name="Regyr" value="2007">2007</button>
    <button id="btn2" type="submit" name="Regyr" value="2006">2006</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="2005">2005</button>
    <button id="btn2" type="submit" name="Regyr" value="2004">2004</button>
    <button id="btn2" type="submit" name="Regyr" value="2003">2003</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="2002">2002</button>
    <button id="btn2" type="submit" name="Regyr" value="2001">2001</button>
    <button id="btn2" type="submit" name="Regyr" value="2000">2000</button><br><br>
    <button id="btn2" type="submit" name="Regyr" value="1999">1999</button>
    <button id="btn2" type="submit" name="Regyr" value="1998">1998</button>
    <button id="btn2" type="submit" name="Regyr" value="1997">1997</button>
</form>
</div>
 <!--==========================
    Footer
