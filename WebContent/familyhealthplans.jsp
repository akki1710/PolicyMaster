...
<h3>Your details</h3>
	<li>	
		...
		<li>
		<label class="w3ls-opt">City: <span class="w3ls-star"> * </span> </label>
		<div class="w3ls-text w3ls-name">
		<span class="agile_sub-label xxx">
					<select name="city" class="month">
										<option>City</option>
	...
	<li>
		...
		<label class="w3ls-opt">phone number :<span class="w3ls-star"> * </span></label>	
			<span class="w3ls-text w3ls-name">
				<input type="phoneno" name="phoneno" placeholder="phone number" required=""/>
			</span>
			</div>
	</li>
