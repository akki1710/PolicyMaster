...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="BOLERO">BOLERO</button>
    <button id="btn1" type="submit" name="b1" value="KUV100">KUV100</button><br><br>
    <button id="btn1" type="submit" name="b1" value="QUANTO">QUANTO</button>
    <button id="btn1" type="submit" name="b1" value="SCORPIO">SCORPIO</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SCORPIO CRDE">SCORPIO CRDE</button>
    <button id="btn1" type="submit" name="b1" value="SCORPIO M HAWK">SCORPIO M HAWK</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SCORPIO M2DICR">SCORPIO M2DICR</button>
	<button id="btn1" type="submit" name="b1" value="THAR">THAR</button><br><br>
    <button id="btn1" type="submit" name="b1" value="TUV300">TUV300</button>
    <button id="btn1" type="submit" name="b1" value="VERITO">VERITO</button><br><br>
    <button id="btn1" type="submit" name="b1" value="XUV500">XUV500</button>
	<button id="btn1" type="submit" name="b1" value="XYLO">XYLO</button>
	</form>
</div>
 <!--==========================
    Footer
