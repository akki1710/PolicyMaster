...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="AVVENTURE">AVVENTURE</button>
    <button id="btn1" type="submit" name="b1" value="GRANDE PUNTO">GRANDE PUNTO</button><br><br>
    <button id="btn1" type="submit" name="b1" value="LINEA">LINEA</button>
    <button id="btn1" type="submit" name="b1" value="LINEACLASSIC">LINEACLASSIC</button><br><br>
    <button id="btn1" type="submit" name="b1" value="PALIO">PALIO</button>
    <button id="btn1" type="submit" name="b1" value="PALIO STILE">PALIO STILE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="PALIO STILE MULTIJET">PALIO STILE MULTIJET</button>
	<button id="btn1" type="submit" name="b1" value="PETRA">PETRA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SIENA">SIENA</button>
    <button id="btn1" type="submit" name="b1" value="UNO">UNO</button><br><br>
    <button id="btn1" type="submit" name="b1" value="URBAN CROSS">URBAN CROSS</button>
	<button id="btn1" type="submit" name="b1" value="PUNTO PURE">PUNTO PURE</button>
	</form>
</div>
 <!--==========================
    Footer
