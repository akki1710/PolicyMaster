...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="AMEO">AMEO</button>
    <button id="btn1" type="submit" name="b1" value="JETTA">JETTA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="NEW BETTLE">NEW BETTLE</button>
    <button id="btn1" type="submit" name="b1" value="PASSAT">PASSAT</button><br><br>
    <button id="btn1" type="submit" name="b1" value="POLO">POLO</button>
    <button id="btn1" type="submit" name="b1" value="POLO GT">POLO GT</button><br><br>
    <button id="btn1" type="submit" name="b1" value="TIGUAN">TIGUAN</button>
    <button id="btn1" type="submit" name="b1" value="VENTO">VENTO</button>
	</form>
</div>
 <!--==========================
    Footer
