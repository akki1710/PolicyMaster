...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="CENTURO">CENTURO</button>
    <button id="btn1" type="submit" name="bk1" value="DURO">DURO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="GUSTO">GUSTO</button>
    <button id="btn1" type="submit" name="bk1" value="RODEO">RODEO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SYM FLYTE">SYM FLYTE</button>
    <button id="btn1" type="submit" name="bk1" value="KINE">KINE</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="MOJO">MOJO</button>
	<button id="btn1" type="submit" name="bk1" value="PANTERO">PANTERO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="STALLIO">STALLIO</button>
    <button id="btn1" type="submit" name="bk1" value="ZESTO">ZESTO</button><br><br>
</form>
</div>
 <!--==========================
    Footer
