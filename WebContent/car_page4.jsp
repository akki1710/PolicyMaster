...
String fuel=(String) session.getAttribute("FuelType");
if(model.equals("DZIRE")&&fuel.equals("DIESEL")){
%>
<div class='container' style="width:60%">
<form action="Servlet1" method="post">
<p>CAR INSURANCE</p>
	<h2><span class="label success">Select a Variant</span></h2><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZDI PLUS">DZIRE ZDI PLUS</button>
    <button id="btn1" type="submit" name="Variant" value="DZIRE LDI">DZIRE LDI</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZDI AMT">DZIRE ZDI AMT</button>
	<button id="btn1" type="submit" name="Variant" value="DZIRE ZDI PLUS AMT">DZIRE ZDI PLUS AMT</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE VDI">DZIRE VDI</button>
    <button id="btn1" type="submit" name="Variant" value="DZIRE VDI AMT">DZIRE VDI AMT</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZDI">DZIRE ZDI</button>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZXI">DZIRE ZXI</button>
</form>
</div>
<%}
else if(model.equals("DZIRE")&&fuel.equals("PETROL")){ %>
<div class='container' style="width:60%">
<form action="Servlet1" method="post">
<p>CAR INSURANCE</p>
	<h2><span class="label success">Select a Variant</span></h2><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE LXI">DZIRE LXI</button>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZXI PLUS">DZIRE ZXI PLUS</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZXI AMT">DZIRE ZXI AMT</button>
	<button id="btn1" type="submit" name="Variant" value="DZIRE ZXI PLUS AMT">DZIRE ZXI PLUS AMT</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE VXI AMT">DZIRE VXI AMT</button>
    <button id="btn1" type="submit" name="Variant" value="DZIRE VXI">DZIRE VXI</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="DZIRE ZXI">DZIRE ZXI</button>
</form>
</div>
<%} %>
