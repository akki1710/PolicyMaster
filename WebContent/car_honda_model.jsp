...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="ACCORD">ACCORD</button>
    <button id="btn1" type="submit" name="b1" value="AMAZE">AMAZE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="BR-V">BR-V</button>
    <button id="btn1" type="submit" name="b1" value="BRIO">BRIO</button><br><br>
    <button id="btn1" type="submit" name="b1" value="CITY">CITY</button>
    <button id="btn1" type="submit" name="b1" value="CITY ZX">CITY ZX</button><br><br>
    <button id="btn1" type="submit" name="b1" value="CIVIC">CIVIC</button>
	<button id="btn1" type="submit" name="b1" value="CIVIC HYBRID">CIVIC HYBRID</button><br><br>
    <button id="btn1" type="submit" name="b1" value="CRV">CRV</button>
    <button id="btn1" type="submit" name="b1" value="JAZZ">JAZZ</button><br><br>
    <button id="btn1" type="submit" name="b1" value="MOBILIO">MOBILIO</button>
	<button id="btn1" type="submit" name="b1" value="NEW CITY">NEW CITY</button>
	</form>
</div>
 <!--==========================
    Footer
