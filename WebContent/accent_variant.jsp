...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="Variant" value="ACCENT VIVA ABS">ACCENT VIVA ABS</button>
    <button id="btn1" type="submit" name="Variant" value="ACCENT CNG">ACCENT CNG</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="ACCENT DLS">ACCENT DLS</button>
	<button id="btn1" type="submit" name="Variant" value="ACCENT Gvs">ACCENT Gvs</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="ACCENT GLE">ACCENT GLE</button>
    <button id="btn1" type="submit" name="Variant" value="ACCENT GLE 1">ACCENT GLE 1</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="ACCENT GLE 2">ACCENT GLE 2</button>
    <button id="btn1" type="submit" name="Variant" value="ACCENT Executive">ACCENT Executive</button>
</form>
</div>
 <!--==========================
    Footer
