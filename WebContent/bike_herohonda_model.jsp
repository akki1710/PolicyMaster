...
<header id="header">
      <div id="logo" class="pull-left">
        <a href="#intro"><img src="img/pm3.png" alt="" title="" /></a>
      </div>
...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="PASSION PRO">PASSION PRO</button>
    <button id="btn1" type="submit" name="bk1" value="SPLENDOR PLUS">SPLENDOR PLUS</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="PASSION PLUS">PASSION PLUS</button>
    <button id="btn1" type="submit" name="bk1" value="CBZ X TREME">CBZ X TREME</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="CD DELUXE">CD DELUXE</button>
    <button id="btn1" type="submit" name="bk1" value="GLAMOUR">GLAMOUR</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SPLENDOR">SPLENDOR</button>
	<button id="btn1" type="submit" name="bk1" value="PLEASURE">PLEASURE</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SPLENDOR PRO">SPLENDOR PRO</button>
    <button id="btn1" type="submit" name="bk1" value="SUPER SPLENDOR">SUPER SPLENDOR</button><br><br>
</form>
</div>
 <!--==========================
    Footer
