...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="FZS">FZS</button>
    <button id="btn1" type="submit" name="bk1" value="FZ 16">FZ 16</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="FAZER">FAZER</button>
    <button id="btn1" type="submit" name="bk1" value="FZ">FZ</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="YZF R15">YZF R15</button>
    <button id="btn1" type="submit" name="bk1" value="RAY">RAY</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SZ R">SZ R</button>
	<button id="btn1" type="submit" name="bk1" value="ALPHA">ALPHA</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="GLADIATOR">GLADIATOR</button>
    <button id="btn1" type="submit" name="bk1" value="SS">SS</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="XJR 1300">XJR 1300</button>
    <button id="btn1" type="submit" name="bk1" value="XTZ 125">XTZ 125</button><br><br>
</form>
</div>
 <!--==========================
    Footer
