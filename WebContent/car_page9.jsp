...
<form class="contactForm" action="Servlet2" method="post">
<p>CAR INSURANCE</p>
	...
	<input type="text" placeholder="MOBILE" name="Mobile" pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit mobile number"  required=""/><br><br>
    <button id="btn2">Continue</button><br><br>
