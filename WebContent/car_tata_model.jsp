...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="INDICA eV2 CR4 (DIESEL)">INDICA eV2 CR4 (DIESEL)</button>
    <button id="btn1" type="submit" name="b1" value="INDICA eV2 XETA">INDICA eV2 XETA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="INDICA V2">INDICA V2</button>
    <button id="btn1" type="submit" name="b1" value="INDICA VISTA">INDICA VISTA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="INDIGO">INDIGO</button>
    <button id="btn1" type="submit" name="b1" value="INDIGO CS">INDIGO CS</button><br><br>
    <button id="btn1" type="submit" name="b1" value="INDIGO eCS">INDIGO eCS</button>
    <button id="btn1" type="submit" name="b1" value="INDIGO MANZA">INDIGO MANZA</button><br><br>
	<button id="btn1" type="submit" name="b1" value="NANO">NANO</button>
    <button id="btn1" type="submit" name="b1" value="SAFARI DICOR 2.2 VTT">SAFARI DICOR 2.2 VTT</button><br><br>
    <button id="btn1" type="submit" name="b1" value="TIAGO">TIAGO</button>
    <button id="btn1" type="submit" name="b1" value="ZEST">ZEST</button><br><br>
    </form>
</div>
 <!--==========================
    Footer
