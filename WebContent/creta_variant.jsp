...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.4 S PLUS CRDI">CRETA 1.4 S PLUS CRDI</button>
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.4 E Plus">CRETA 1.4 E Plus</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.6 E">CRETA 1.6 E</button>
	<button id="btn1" type="submit" name="Variant" value="CRETA 1.6 E Plus">CRETA 1.6 E Plus</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.6 SX">CRETA 1.6 SX</button>
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.6 SX Dual Tone">CRETA 1.6 SX Dual Tone</button><br><br>
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.6 SX Automatic">CRETA 1.6 SX Automatic</button>
    <button id="btn1" type="submit" name="Variant" value="CRETA 1.6 SX Option ">CRETA 1.6 SX Option </button>
</form>
</div>
 <!--==========================
    Footer
