...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="MAESTRO">MAESTRO</button>
    <button id="btn1" type="submit" name="bk1" value="PASSION PRO">PASSION PRO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SPLENDOR PRO">SPLENDOR PRO</button>
    <button id="btn1" type="submit" name="bk1" value="PASSION XPRO">PASSION XPRO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="HF DELUXE">HF DELUXE</button>
    <button id="btn1" type="submit" name="bk1" value="SPLENDOR PLUS">SPLENDOR PLUS</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="GLAMOUR">GLAMOUR</button>
	<button id="btn1" type="submit" name="bk1" value="PLEASURE">PLEASURE</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SPLENDOR ISMART">SPLENDOR ISMART</button>
    <button id="btn1" type="submit" name="bk1" value="IGNITOR">IGNITOR</button><br><br>
</form>
</div>
 <!--==========================
    Footer
