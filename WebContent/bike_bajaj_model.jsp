...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="PULSAR 150 DTSI">PULSAR 150 DTSI</button>
    <button id="btn1" type="submit" name="bk1" value="APACHE">APACHE</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="DISCOVER 125">DISCOVER 125</button>
    <button id="btn1" type="submit" name="bk1" value="AVENGER">AVENGER</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="DISCOVER">DISCOVER</button>
    <button id="btn1" type="submit" name="bk1" value="PLATINA">PLATINA</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="PULSAR 180 DTSI">PULSAR 180 DTSI</button>
	<button id="btn1" type="submit" name="bk1" value="PULSAR 135 DTSI">PULSAR 135 DTSI</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="DISCOVER 150">DISCOVER 150</button>
    <button id="btn1" type="submit" name="bk1" value="PULSAR NS">PULSAR NS</button><br><br>
</form>
</div>
 <!--==========================
    Footer
