...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="CLASSIC">CLASSIC</button>
    <button id="btn1" type="submit" name="bk1" value="THUNDERBIRD">THUNDERBIRD</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ELECTRA">ELECTRA</button>
    <button id="btn1" type="submit" name="bk1" value="BULLET">BULLET</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="CONTINENTAL GT">CONTINENTAL GT</button>
    <button id="btn1" type="submit" name="bk1" value="MACHISMO">MACHISMO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ELEDRO">ELEDRO</button>
	<button id="btn1" type="submit" name="bk1" value="HIMALAYAN">HIMALAYAN</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="INTERCEPTOR">INTERCEPTOR</button>
    <button id="btn1" type="submit" name="bk1" value="METEOR">METEOR</button><br><br>
</form>
</div>
 <!--==========================
    Footer
