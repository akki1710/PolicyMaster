...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="DUSTER">DUSTER</button>
    <button id="btn1" type="submit" name="b1" value="FLUENCE">FLUENCE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="KOLEOS">KOLEOS</button>
    <button id="btn1" type="submit" name="b1" value="KWId">KWId</button><br><br>
    <button id="btn1" type="submit" name="b1" value="LODGY">LODGY</button>
    <button id="btn1" type="submit" name="b1" value="PULSE">PULSE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SCALA">SCALA</button>
	<button id="btn1" type="submit" name="b1" value="CAPTUR">CAPTUR</button><br><br>
	</form>
</div>
 <!--==========================
    Footer
