...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="FABIA">FABIA</button>
    <button id="btn1" type="submit" name="b1" value="LAURA">LAURA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="OCTAVIA">OCTAVIA</button>
    <button id="btn1" type="submit" name="b1" value="OCTAVIA COMBI">OCTAVIA COMBI</button><br><br>
    <button id="btn1" type="submit" name="b1" value="RAPID">RAPID</button>
    <button id="btn1" type="submit" name="b1" value="SUPERB">SUPERB</button><br><br>
    <button id="btn1" type="submit" name="b1" value="YETI">YETI</button>
	<button id="btn1" type="submit" name="b1" value="KODIAQ">KODIAQ</button><br><br>
	</form>
</div>
 <!--==========================
    Footer
