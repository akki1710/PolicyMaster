...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="FuelType" value="Petrol">Petrol</button><br><br>
    <button id="btn1" type="submit" name="FuelType" value="Diesel">Diesel</button><br><br>
    <button id="btn1" type="submit" name="FuelType" value="CNG">CNG</button><br><br>
    <button id="btn1" type="submit" name="FuelType" value="LPG">LPG</button><br><br>
    <button id="btn1" type="submit" name="FuelType" value="External CNG kit">External CNG kit</button>
</form>
</div>
 <!--==========================
    Footer
