...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="AVEO">AVEO</button>
    <button id="btn1" type="submit" name="b1" value="AVEO UVA">AVEO UVA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="BEAT">BEAT</button>
    <button id="btn1" type="submit" name="b1" value="CRUZE">CRUZE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="ENJOY">ENJOY</button>
    <button id="btn1" type="submit" name="b1" value="OPTRA">OPTRA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="OPTRA MAGNUM">OPTRA MAGNUM</button>
	<button id="btn1" type="submit" name="b1" value="SAIL">SAIL</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SAIL UVA">SAIL UVA</button>
    <button id="btn1" type="submit" name="b1" value="SPARK">SPARK</button><br><br>
    <button id="btn1" type="submit" name="b1" value="TAVERA">TAVERA</button>
	<button id="btn1" type="submit" name="b1" value="TAVERA NEO 3">TAVERA NEO 3</button>
	</form>
</div>
 <!--==========================
    Footer
