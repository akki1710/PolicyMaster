      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active"> 
             <div class="bgimg"><img src="img/other1.jpg" alt="" style="width:100%"></div>
		 ...
		 <div class="row">
                 <div class="col-lg-3 col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    ...
                    <h4 class="title"><a href="general.jsp">General Insurance</a></h4>
			</div>
             		 </div>
             		 <div class="col-lg-3 col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s" onclick=newDoc1()>
                  <div class="align-center">
                    <i class="fa fa-group fa-5x" style="color:white"></i>
                    <h4 class="title"><a href="groupmediclaim.jsp">Group Medical Insurance</a></h4>
			</div>
               		</div>
                  ...
                  <div class="align-center">
                    ...
                    <h4 class="title"><a href="corporate.jsp">Corporate Insurance</a></h4>
			</div>
               		</div>
                ...
                <div class="col-lg-3 col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">
                    ...
                    <h4 class="title"><a href="travel.jsp">Travel Insurance</a></h4>
			</div>
        		  </div>     	
		 
                <div class="col-lg-5 col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">
                    <i class="fa fa-home fa-5x" style="color:white"></i>
                    <h4 class="title"><a href="homeinsurance.jsp">Home Insurance</a></h4>
			</div>
               		</div>
               		<div class="col-lg-2 col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">
                    <i class="fa fa-car fa-5x" style="color:white"></i>
                    <h4 class="title"><a href="personalaccident.jsp">Personal Accident Insurance</a></h4>
			</div>
               		</div>
					
					
					
					 <div class="col-lg-4 col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">
                    <i class="fa fa-plus-circle fa-5x" style="color:white"></i>
                    <h4 class="title"><a href="cancer.jsp">Cancer Insurance</a></h4>
			</div>
               		</div>
