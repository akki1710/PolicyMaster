...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="APACHE">APACHE</button>
    <button id="btn1" type="submit" name="bk1" value="JUPITER">JUPITER</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SCOOTY">SCOOTY</button>
    <button id="btn1" type="submit" name="bk1" value="WEGO">WEGO</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="STAR CITY">STAR CITY</button>
    <button id="btn1" type="submit" name="bk1" value="SPORT">SPORT</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="VICTOR">VICTOR</button>
	<button id="btn1" type="submit" name="bk1" value="XL SUPER">XL SUPER</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ZEST">ZEST</button>
    <button id="btn1" type="submit" name="bk1" value="PHOENIX">PHOENIX</button><br><br>
</form>
</div>
 <!--==========================
    Footer
