...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="800">800</button>
    <button id="btn1" type="submit" name="b1" value="800 Duo">800 Duo</button><br><br>
    <button id="btn1" type="submit" name="b1" value="ALTO">ALTO</button>
    <button id="btn1" type="submit" name="b1" value="ALTO 800">ALTO 800</button><br><br>
    <button id="btn1" type="submit" name="b1" value="ALTO K10B">ALTO K10B</button>
    <button id="btn1" type="submit" name="b1" value="CELERIO">CELERIO</button><br><br>
    <button id="btn1" type="submit" name="b1" value="ERTIGA">ERTIGA</button>
	<button id="btn1" type="submit" name="b1" value="RITZ">RITZ</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SWIFT">SWIFT</button>
    <button id="btn1" type="submit" name="b1" value="SWIFT DZIRE">SWIFT DZIRE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SWIFT DZIRE KB">SWIFT DZIRE KB</button>
    <button id="btn1" type="submit" name="b1" value="SWIFT KB">SWIFT KB</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SWIFT RANGE EXTENDER">SWIFT RANGE EXTENDER</button>
    <button id="btn1" type="submit" name="b1" value="SX4">SX4</button><br><br>
    <button id="btn1" type="submit" name="b1" value="VITARA BREZZA">Vitara Brezza</button>
    <button id="btn1" type="submit" name="b1" value="WAGON R">WAGON R</button><br><br>
    <button id="btn1" type="submit" name="b1" value="CELERIO">CELERIO X</button>
    <button id="btn1" type="submit" name="b1" value="SWIFT" >SWIFT (2018)</button>
    </form>
</div>
 <!--==========================
    Footer
