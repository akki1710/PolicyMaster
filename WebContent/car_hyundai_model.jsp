...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="ACCENT">ACCENT</button>
    <button id="btn1" type="submit" name="b1" value="CRETA">CRETA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="EON">EON</button>
    <button id="btn1" type="submit" name="b1" value="FLUIDIC VERNA">FLUIDIC VERNA</button><br><br>
    <button id="btn1" type="submit" name="b1" value="GRAND i10">GRAND i10</button>
    <button id="btn1" type="submit" name="b1" value="i 10 1.1">i 10 1.1</button><br><br>
    <button id="btn1" type="submit" name="b1" value="i 10 1.2 KAPPA">i 10 1.2 KAPPA</button>
	<button id="btn1" type="submit" name="b1" value="i 20">i 20</button><br><br>
    <button id="btn1" type="submit" name="b1" value="SANTRO">SANTRO</button>
    <button id="btn1" type="submit" name="b1" value="SANTRO XING">SANTRO XING</button><br><br>
    <button id="btn1" type="submit" name="b1" value="VERNA">VERNA</button>
	<button id="btn1" type="submit" name="b1" value="XCENT">XCENT</button>
	</form>
</div>
 <!--==========================
    Footer
