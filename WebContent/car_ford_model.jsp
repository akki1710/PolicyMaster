...
<p>CAR INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="b1" value="ECOSPORT">ECOSPORT</button>
    <button id="btn1" type="submit" name="b1" value="ENDEAVOUR">ENDEAVOUR</button><br><br>
    <button id="btn1" type="submit" name="b1" value="FIESTA">FIESTA</button>
    <button id="btn1" type="submit" name="b1" value="FIESTA 1.5">FIESTA 1.5</button><br><br>
    <button id="btn1" type="submit" name="b1" value="FIGO">FIGO</button>
    <button id="btn1" type="submit" name="b1" value="FIGO ASPIRE">FIGO ASPIRE</button><br><br>
    <button id="btn1" type="submit" name="b1" value="FUSION">FUSION</button>
	<button id="btn1" type="submit" name="b1" value="FUSION PLUS">FUSION PLUS</button><br><br>
    <button id="btn1" type="submit" name="b1" value="IKON">IKON</button>
    <button id="btn1" type="submit" name="b1" value="FREESTYLE">FREESTYLE</button><br><br>
	</form>
</div>
 <!--==========================
    Footer
