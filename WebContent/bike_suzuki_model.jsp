...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="ACCESS">ACCESS</button>
    <button id="btn1" type="submit" name="bk1" value="GIXXER">GIXXER</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SWISH">SWISH</button>
    <button id="btn1" type="submit" name="bk1" value="GS150R">GS150R</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="UZ">UZ</button>
    <button id="btn1" type="submit" name="bk1" value="HAYATE">HAYATE</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SLINGSHOT">SLINGSHOT</button>
	<button id="btn1" type="submit" name="bk1" value="LETS">LETS</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ZEUS">ZEUS</button>
    <button id="btn1" type="submit" name="bk1" value="HEAT">HEAT</button><br><br>
</form>
</div>
 <!--==========================
    Footer
