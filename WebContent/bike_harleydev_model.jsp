...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="SPORTSTER">SPORTSTER</button>
    <button id="btn1" type="submit" name="bk1" value="STREET">STREET</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="FAT BOY">FAT BOY</button>
    <button id="btn1" type="submit" name="bk1" value="FORTY EIGHT">FORTY EIGHT</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="XL 1200">XL 1200</button>
    <button id="btn1" type="submit" name="bk1" value="SUPER GLIDE CUSTOM">SUPER GLIDE CUSTOM</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="ROAD KING">ROAD KING</button>
	<button id="btn1" type="submit" name="bk1" value="SOFTAIL">SOFTAIL</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="FX STANDARD">FX STANDARD</button>
    <button id="btn1" type="submit" name="bk1" value="V-ROD">V-ROD</button><br><br>
