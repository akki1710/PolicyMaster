...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="DUKE">DUKE</button>
    <button id="btn1" type="submit" name="bk1" value="RC">RC</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="690">690</button>
    <button id="btn1" type="submit" name="bk1" value="SUPER DUKE">SUPER DUKE</button><br><br>
</form>
</div>
 <!--==========================
    Footer
