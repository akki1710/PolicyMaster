...
<style>
body{
background-image: url('img/pension1.jpg');
...
<h3>Your details</h3>
	<li>	
		...
		<div class="w3ls-name">	
			<input type="text" name="amount"  placeholder="50,000" required=" "/>
		</div>
	</li>
	...
	<li>	
		<label class="w3ls-opt">Age(Retirement) :<span class="w3ls-star"> * </span></label>
		<div class="w3ls-name">	
			<input type="text" name="retirementage"  placeholder="Age" required=" "/>
		</div>
	</li>
	<li>
