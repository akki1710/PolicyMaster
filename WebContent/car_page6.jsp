...
<p>CAR INSURANCE</p>
	<h2><span class="label success">Select Previous Insurer</span></h2><br>
    <button id="btn1" type="submit" name="PreIns" value="Cholamandalam">Cholamandalam</button>
    <button id="btn1" type="submit" name="PreIns" value="ICICI Lombard">ICICI Lombard</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="National Insurance">National Insurance</button>
    <button id="btn1" type="submit" name="PreIns" value="Shriram General Insurance">Shriram General Insurance</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Bajaj Allianz General Insurance Company Limited">Bajaj Allianz</button>
    <button id="btn1" type="submit" name="PreIns" value="Bharti Axa">Bharti Axa</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Future Generali">Future Generali</button>
	<button id="btn1" type="submit" name="PreIns" value="HDFC ERGO">HDFC ERGO</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Iffco Tokio">Iffco Tokio</button>
    <button id="btn1" type="submit" name="PreIns" value="Kotak">Kotak</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="L&T">L&T</button>
    <button id="btn1" type="submit" name="PreIns" value="Liberty General Insurance">Liberty General Insurance</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="MAGMA HDI">Magma HDI</button>
    <button id="btn1" type="submit" name="PreIns" value="New India Assurance">New India Assurance</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Oriental">Oriental</button>
    <button id="btn1" type="submit" name="PreIns" value="Reliance">Reliance</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Royal Sundaram">Royal Sundaram</button>
    <button id="btn1" type="submit" name="PreIns" value="SBI">SBI</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Tata AIG">Tata AIG</button>
    <button id="btn1" type="submit" name="PreIns" value="United Insurance">United Insurance</button><br><br>
    <button id="btn1" type="submit" name="PreIns" value="Universal Sompo">Universal Sompo</button>
    <button id="btn1" type="submit" name="PreIns" value="Axis">Axis</button>
</form>
</div>
 <!--==========================
    Footer
