...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn3" type="submit" name="bk3" value="Brandnew">I have a Brand New Bike</button><br><br>
    <button id="btn2" type="submit" name="bk3" value="2017">2017</button>
    <button id="btn2" type="submit" name="bk3" value="2016">2016</button>
    <button id="btn2" type="submit" name="bk3" value="2015">2015</button><br><br>
    <button id="btn2" type="submit" name="bk3" value="2014">2014</button>
    <button id="btn2" type="submit" name="bk3" value="2013">2013</button>
    <button id="btn2" type="submit" name="bk3" value="2012">2012</button><br><br>
    <button id="btn2" type="submit" name="bk3" value="2011">2011</button>
	<button id="btn2" type="submit" name="bk3" value="2010">2010</button>
    <button id="btn2" type="submit" name="bk3" value="2009">2009</button><br><br>
    <button id="btn2" type="submit" name="bk3" value="2008">2008</button>
    <button id="btn2" type="submit" name="bk3" value="2007">2007</button>
    <button id="btn2" type="submit" name="bk3" value="2006">2006</button><br><br>
    <button id="btn2" type="submit" name="bk3" value="2005">2005</button>
    <button id="btn2" type="submit" name="bk3" value="2004">2004</button>
    <button id="btn2" type="submit" name="bk3" value="2003">2003</button>
</form>
</div>
 <!--==========================
    Footer
