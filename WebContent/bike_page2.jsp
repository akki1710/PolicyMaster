...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk1" value="ACTIVA">ACTIVA</button>
    <button id="btn1" type="submit" name="bk1" value="CB SHINE">CB SHINE</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="CB UNICORN">CB UNICORN</button>
    <button id="btn1" type="submit" name="bk1" value="AVIATOR">AVIATOR</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="SHINE">SHINE</button>
    <button id="btn1" type="submit" name="bk1" value="UNICORN">UNICORN</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="DIO">DIO</button>
	<button id="btn1" type="submit" name="bk1" value="DREAM YUGA">DREAM YUGA</button><br><br>
    <button id="btn1" type="submit" name="bk1" value="CB TWISTER">CB TWISTER</button>
    <button id="btn1" type="submit" name="bk1" value="ACTIVA-I">ACTIVA-I</button><br><br>
</form>
</div>
 <!--==========================
    Footer
