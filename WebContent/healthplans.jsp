...
<h3>Your details</h3> 
	<li>	
		...
		<div class="w3ls-name">	
		<input type="text" name="members" class="btn btn-link-1 launch-modal" data-modal-id="modal-login" required=" " placeholder="Select Members"/>
		</div>
	</li>
		<li>
...
<li>
							<label class="w3ls-opt">Title: <span class="w3ls-star"> * </span> </label>
								<div class="w3ls-text w3ls-name">
									<span class="agile_sub-label xxx">
										<select name="title" class="month">
											<option>Title</option>
	...
	<li>	
		...
		<div class="w3ls-name">	
			<input type="name" name="name"  placeholder="Enter Your Name" pattern="[a-zA-Z]+\s+[a-zA-Z]+" title="Please enter full name" required=" "/>
		</div>
	</li>
...
IRDAI Licence : IRDAI/INT/WBA/48/2017</footer>
        ...
        <div class="modal fade" id="modal-login" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true">
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
							<li>
							<label class="w3ls-opt"><input type="checkbox" name="member[]" class="member" value="self"> Self</label>
							<div class="w3ls-text w3ls-name">
									<span class="agile_sub-label xxx">
			...
			<div class="clear"></div>
							...
							<li>
							<label class="w3ls-opt"><input type="checkbox"  class="member" value="spouse"> Spouse</label>
							<div class="w3ls-text w3ls-name">
									<span class="agile_sub-label xxx">
							<select name="age1" class="month">
											<option value="">Age</option>
											<option value="18"> 18 </option>
											<option value="19"> 19 </option>
											<option value="20"> 20 </option>
			...
			<div class="clear"></div>
							...
							<li>
							<label class="w3ls-opt"><input type="checkbox"  class="member" value="son"> Son</label>
							<div class="w3ls-text w3ls-name">
									<span class="agile_sub-label xxx">
			...
			<div class="clear"></div>
							...
							<li>
							<label class="w3ls-opt"><input type="checkbox"  class="member" value="daughter"> Daughter</label>
							<div class="w3ls-text w3ls-name">
									<span class="agile_sub-label xxx">
			...
			<div class="clear"></div>
	                        ...
	                        <div class="text-center"><button type="button" class="btn get_member_list_btn">Done</button></div>
        		...
        		var mem_age="";
        		   $.each($(".member:checked"), function(){            
                		mem_age = $(this).parents('li').find('select.month').val();
                                if(mem_age==""){alert("Please select age of "+$(this).val());return;}
                                else{members.push($(this).val()+"("+mem_age+")")}
          		  });
