...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk2" value="3G (110 CC)">3G (110 CC)</button>
    <button id="btn1" type="submit" name="bk2" value="4G (110 CC)">4G (110 CC)</button><br><br>
    <button id="btn1" type="submit" name="bk2" value="5G (110 CC)">5G (110 CC)</button>
	<button id="btn1" type="submit" name="bk2" value="DLX (110 CC)">DLX (110 CC)</button><br><br>
    <button id="btn1" type="submit" name="bk2" value="DLX (125 CC)">DLX (125 CC)</button>
    <button id="btn1" type="submit" name="bk2" value="ELECTRIC START (110 CC)">ELECTRIC START (110 CC)</button><br><br>
    <button id="btn1" type="submit" name="bk2" value="HET (110 CC)">HET (110 CC)</button>
    <button id="btn1" type="submit" name="bk2" value="STD (102 CC)">STD (102 CC)</button>
</form>
</div>
 <!--==========================
    Footer
