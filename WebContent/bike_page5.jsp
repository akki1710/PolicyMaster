...
<p>BIKE INSURANCE</p>
    ...
    <button id="btn1" type="submit" name="bk4" value="Cholamandalam">Cholamandalam</button>
    <button id="btn1" type="submit" name="bk4" value="ICICI Lombard">ICICI Lombard</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="National Insurance">National Insurance</button>
    <button id="btn1" type="submit" name="bk4" value="Shriram General Insurance">Shriram General Insurance</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Bajaj Allianz">Bajaj Allianz</button>
    <button id="btn1" type="submit" name="bk4" value="Bharti Axa">Bharti Axa</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Future Generali">Future Generali</button>
	<button id="btn1" type="submit" name="bk4" value="HDFC ERGO">HDFC ERGO</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Iffco Tokio">Iffco Tokio</button>
    <button id="btn1" type="submit" name="bk4" value="Kotak">Kotak</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="L&T">L&T</button>
    <button id="btn1" type="submit" name="bk4" value="Liberty General Insurance">Liberty General Insurance</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="MAGMA HDI">MAGMA HDI</button>
    <button id="btn1" type="submit" name="bk4" value="New India Assurance">New India Assurance</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Oriental">Oriental</button>
    <button id="btn1" type="submit" name="bk4" value="Reliance">Reliance</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Royal Sundaram">Royal Sundaram</button>
    <button id="btn1" type="submit" name="bk4" value="SBI">SBI</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Tata AIG">Tata AIG</button>
    <button id="btn1" type="submit" name="bk4" value="United Insurance">United Insurance</button><br><br>
    <button id="btn1" type="submit" name="bk4" value="Universal Sompo">Universal Sompo</button>
    <button id="btn1" type="submit" name="bk4" value="Axis">Axis</button>
</form>
</div>
 <!--==========================
    Footer
